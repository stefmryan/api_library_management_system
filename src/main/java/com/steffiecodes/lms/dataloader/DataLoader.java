...
public class DataLoader implements CommandLineRunner {
    ...
    private void addItemsToCatalog() {
        ...
        Holds holds1 = new Holds(date1, 1, book1, null);
        holdsRepository.save(holds1);
    }
